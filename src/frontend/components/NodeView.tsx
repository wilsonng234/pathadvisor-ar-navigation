...
const NodeView = ({ currentFloorId, node }: NodeViewProps) => {
    ...
    if (!node.centerCoordinates || !floors || !tags)
        return null;
    ...
    return (
        <View style={styles.container((node.centerCoordinates[0] - tileStartX) * (RENDER_MAP_TILE_WIDTH / LOGIC_MAP_TILE_WIDTH), (node.centerCoordinates[1] - tileStartY) * (RENDER_MAP_TILE_HEIGHT / LOGIC_MAP_TILE_HEIGHT))}>
            {
